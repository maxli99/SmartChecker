...
u"""
 检查Flexi NG设备丢包数量。
    --通过网管数据库获取SAEGW/GGSN的告警分析。
    --获取数据指令:
        OSS_query_v2.exe -D2016/07/25 -T1000 -d2016/07/25 -t1200 -cALARM -uSAEGW -l1
...
check_commands = [
    ...
    ('OSS_query_v2.exe -D2016/07/25 -T1000 -d2016/07/25 -t1200 -cALARM -uSAEGW -l1','## get ng data about the count of packets dropped'),
]
